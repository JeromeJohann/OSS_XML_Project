...
function App() {
    ...
    function htmlEscaper(htmlString: string) {
        ...
        htmlString = htmlString.replace(/&auml;/g, '\u{00E4}');  // ä
        htmlString = htmlString.replace(/&ouml;/g, '\u{00F6}');  // ö
        htmlString = htmlString.replace(/&uuml;/g, '\u{00FC}');  // ü
        htmlString = htmlString.replace(/&Auml;/g, '\u{00C4}');  // Ä
        htmlString = htmlString.replace(/&Ouml;/g, '\u{00D6}');  // Ö
        htmlString = htmlString.replace(/&Uuml;/g, '\u{00DC}');  // Ü
        htmlString = htmlString.replace(/&szlig;/g, '\u{00DF}'); // ß
        return htmlString;
    }
